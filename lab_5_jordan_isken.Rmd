...
lobster_abundance <- read_csv(here::here("data", "lobster_abundance.csv"),
  ...
  clean_names()
```
Use tidyr::uncount() funtion to convert our lobster data from frequency format to case format
...
use t.test() function to find confidence intervals (for one sample) and perform t-test to compare means of two samples
